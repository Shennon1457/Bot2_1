...
async def buttom_1_click(message: types.Message):
    await bot.send_photo(message.chat.id, photo='https://celebitchy.com/wp-content/uploads/2018/09/wenn35401415.jpg', caption='Леди Гага (настоящее имя — Стефани Джоанна Анджелина Джерманотта) — американская певица, автор песен и актриса. Родилась 28 марта 1986 года в Нью-Йорке.')
